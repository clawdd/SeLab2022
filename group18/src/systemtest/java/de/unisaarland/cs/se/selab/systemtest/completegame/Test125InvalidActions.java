...
public class Test125InvalidActions extends AbstractSystemTest {

    private static final long SEED = 43;
    private static final Random RANDOM = new Random(SEED);

    public Test125InvalidActions() {
        super(Test125InvalidActions.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(Test125InvalidActions.class, "configuration.json");
    }
    ...
    private void secondBiddingEvalSeason(final List<JSONObject> traps)
        ...
        // invalid start
        sendHireMonster(1, 11);
        assertActionFailed(1);

        sendHireMonster(3, 11);
        assertActionFailed(3);

        sendHireMonster(2, 10_001);
    ...
    private void thirdBiddingSeasonEval() throws TimeoutException {
        ...
        sendBuildRoom(3, 0, 4, 7);
        assertActionFailed(3);
        assertActNow(3);

        sendBuildRoom(2, 0, 0, 7);
        assertActionFailed(2);
