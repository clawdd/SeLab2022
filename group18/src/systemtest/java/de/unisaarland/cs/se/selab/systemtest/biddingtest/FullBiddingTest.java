...
public class FullBiddingTest extends AbstractSystemTest {

    private static final long SEED = 43;
    private static final Random RANDOM = new Random(SEED);

    public FullBiddingTest() {
        super(FullBiddingTest.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(FullBiddingTest.class, "configuration.json");
    }
