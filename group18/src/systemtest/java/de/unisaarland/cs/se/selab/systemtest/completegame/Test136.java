...
public class Test136 extends AbstractSystemTest {

    private static final long SEED = 43;
    private static final Random RANDOM = new Random(SEED);

    public Test136() {
        super(Test136.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(Test136.class, "configuration.json");
    }
    ...
    private void combatPlayerOne() throws TimeoutException {
        ...
        assertActNow(2);
        sendMonster(2, 11);
        assertMonsterPlacedForXPlayers(4, 11, 1);
        assertActNow(2);
        sendEndTurn(2);
        assertAdventurerDamagedForXPlayers(4, 5, 1);
        assertAdventurerDamagedForXPlayers(4, 25, 1);
        assertAdventurerDamagedForXPlayers(4, 27, 1);
        assertAdventurerDamagedForXPlayers(4, 27, 2);
        assertAdventurerDamagedForXPlayers(4, 5, 2);
        assertAdventurerImprisonedForXPlayers(4, 25);
        assertTunnelConqueredForXPlayers(4, 27, 0, 0);
        assertEvilnessChangedForXPlayers(4, -1, 1);
        assertAdventurerHealedForXPlayers(4, 2, 27, 27);
        assertAdventurerHealedForXPlayers(4, 1, 5, 27);
        assertAdventurerHealedForXPlayers(4, 1, 5, 5);

        assertNextSeasonForXPlayers(4, 2);
        assertSetBattleGround(2);
        assertActNow(2);
        sendBattleGround(2, 0, 1);
        assertBattleGroundSetForXPlayers(4, 1, 0, 1);
        assertDefendYourself(2);
        assertActNow(2);
        sendTrap(2, 16);
        assertActionFailed(2);
