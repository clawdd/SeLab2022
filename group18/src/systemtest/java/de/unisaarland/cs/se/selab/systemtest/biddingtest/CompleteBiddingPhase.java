...
public class CompleteBiddingPhase extends AbstractSystemTest {

    private static final long SEED = 43;
    private static final Random RANDOM = new Random(SEED);

    public CompleteBiddingPhase() {
        super(CompleteBiddingPhase.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(CompleteBiddingPhase.class, "configuration.json");
    }
