...
public class TunnelTest01HCP extends AbstractSystemTest {

    private static final long SEED = 40;
    private static final Random RANDOM = new Random(SEED);

    public TunnelTest01HCP() {
        super(TunnelTest01HCP.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(TunnelTest01HCP.class, "configuration.json");
    }
