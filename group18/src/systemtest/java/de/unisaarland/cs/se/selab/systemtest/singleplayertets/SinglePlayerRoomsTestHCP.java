...
public class SinglePlayerRoomsTestHCP extends AbstractSystemTest {
    ...
    public SinglePlayerRoomsTestHCP() {
        super(SinglePlayerRoomsTestHCP.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(SinglePlayerRoomsTestHCP.class, "config_for_single_player"
                + ".json");
    }
    ...
    protected void thdBiddingSeason() throws TimeoutException, AssertionError {
        assertActNow(1);
        sendPlaceBid(1, TUNNEL, 1);
        assertBidPlacedForXPlayers(1, TUNNEL, P_1, 1);
        assertActNow(1);
