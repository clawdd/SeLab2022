package de.unisaarland.cs.se.selab.systemtest.combattest;
...
public class TestMegaDamage extends AbstractSystemTest {

    private static final long SEED = 43;
    private static final Random RANDOM = new Random(SEED);

    public TestMegaDamage() {
        super(TestMegaDamage.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(TestMegaDamage.class, "config_mega_damage.json");
    }
    ...
    private void combatPlayerOne() throws TimeoutException {
        ...
        assertAdventurerImprisonedForXPlayers(4, 27);
        assertAdventurerImprisonedForXPlayers(4, 5);
