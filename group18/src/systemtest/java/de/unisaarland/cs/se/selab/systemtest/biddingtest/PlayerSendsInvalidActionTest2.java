...
public class PlayerSendsInvalidActionTest2 extends AbstractSystemTest {

    private static final long SEED = 42;
    private static final Random RANDOM = new Random(SEED);

    public PlayerSendsInvalidActionTest2() {
        super(PlayerSendsInvalidActionTest2.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(PlayerSendsInvalidActionTest2.class, "configuration.json");
    }
