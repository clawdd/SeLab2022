...
public class LeaveDuringBidPlace extends AbstractSystemTest {

    private static final long SEED = 43;
    private static final Random RANDOM = new Random(SEED);

    public LeaveDuringBidPlace() {
        super(LeaveDuringBidPlace.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(LeaveDuringBidPlace.class, "configuration.json");
    }
