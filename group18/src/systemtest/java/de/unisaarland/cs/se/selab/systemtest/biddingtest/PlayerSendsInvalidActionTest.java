...
public class PlayerSendsInvalidActionTest extends AbstractSystemTest {

    private static final long SEED = 42;
    private static final Random RANDOM = new Random(SEED);

    public PlayerSendsInvalidActionTest() {
        super(PlayerSendsInvalidActionTest.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(PlayerSendsInvalidActionTest.class, "configuration.json");
    }
