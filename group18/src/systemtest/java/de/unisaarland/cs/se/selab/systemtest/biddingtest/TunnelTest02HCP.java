...
public class TunnelTest02HCP extends AbstractSystemTest {

    private static final long SEED = 40;
    private static final Random RANDOM = new Random(SEED);

    public TunnelTest02HCP() {
        super(TunnelTest02HCP.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(TunnelTest02HCP.class, "configuration.json");
    }
