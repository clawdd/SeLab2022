...
public class PlayerSendsInvalidActionTest4 extends AbstractSystemTest {

    private static final long SEED = 42;
    private static final Random RANDOM = new Random(SEED);

    public PlayerSendsInvalidActionTest4() {
        super(PlayerSendsInvalidActionTest4.class, false);
    }

    @Override
    protected String createConfig() {
        return Utils.loadResource(PlayerSendsInvalidActionTest4.class, "configuration.json");
    }
    ...
    protected void run() throws TimeoutException, AssertionError {
        ...
        final var monsters = getAndShuffleStock(config, RANDOM, "monsters");
        final var adventurers = getAndShuffleStock(config, RANDOM, "adventurers");
        getAndShuffleStock(
                config, RANDOM, "traps");
        final var rooms = getAndShuffleStock(config, RANDOM, "rooms");
        ...
        sendPlaceBid(3, BidType.TRAP, 3);       // invalid action here
        ...
        sendPlaceBid(4, BidType.IMPS, 4);       // invalid action here
