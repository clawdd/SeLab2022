...
/**
 * This Action handles an attack of a Monster
 */
public class MonsterCommand extends ActionCommand {
     ...
     */
    public MonsterCommand(final StateMachine stateMachine,
    ...
    public ActionCommandEnum execute(final List<Integer> allowedCommIds) {
        ...
        return monsterAction(false, monsterId, -1);
    }
}
